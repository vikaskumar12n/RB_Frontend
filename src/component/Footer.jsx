        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["Build a Resume", "Samples", "Cover Letter Samples", "Apps"].map((item) => (
                <li key={item}>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["Help Center", "About Us", "Sitemap"].map((item) => (
                <li key={item}>
                  <a href="#" className="text-sm text-gray-500 hover:text-gray-900 transition-colors">{item}</a>
                </li>
              ))}
          ...
          <div className="col-span-2 sm:col-span-1">
            ...
            <div className="flex items-center gap-4 mb-5">
              {socialIcons.map(({ label, path }) => (
                <a key={label} href="#" aria-label={label} className="text-gray-500 hover:text-gray-900 transition-colors">
