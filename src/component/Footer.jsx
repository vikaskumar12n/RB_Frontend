        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-8 mb-10">
            ...
            <div className="flex flex-col items-start justify-start">
              ...
              <p className="text-[11px] text-gray-500 text-left max-w-[180px] mt-2 leading-tight">
                Build your professional resume with AI-powered templates
              </p>
            ...
            <div>
              ...
              <button
                onClick={scrollToTop}
                className="fixed right-6 bottom-6 w-12 h-12 rounded-full bg-blue-900 flex items-center justify-center hover:bg-blue-700 transition-all shadow-2xl border border-white/20 group z-50 animate-bounce-subtle"
              >
