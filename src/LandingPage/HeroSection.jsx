...
export default function HeroSection() {
    ...
    return (
        <section className="relative  pt-2 flex flex-col items-center justify-center bg-white   overflow-hidden">
            ...
            <h1
                className={`transition-all duration-700 delay-200 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                    } text-4xl sm:text-3xl md:text-[3.3rem] font-extrabold text-center leading-[1.1] max-w-[700px] mb-5 text-gray-900 tracking-tight`}
            >
            ...
            >
                ...
                <Link to="/home#builder" id="builder" className="border border-gray-200 bg-white hover:bg-gray-50 text-gray-700 font-medium rounded-xl px-7 py-3.5 text-sm transition-colors duration-200">
                    View templates
                </Link>
            </div>
