...
const BusinessDevTemplates = ({ data: propData, setData: setPropData }) => {
  ...
  // ========== PROJECTS FUNCTIONS ==========
  const addProject = () => u("projects", [...ref.current.projects, { title: "New Achievement", description: "Description" }]);
      ...
      <div id="resume" style={{ width: "210mm", minHeight: "297mm", fontFamily: "'Inter', sans-serif", fontSize: "11px", lineHeight: "1.5", backgroundColor: "#fff", color: primary, boxSizing: "border-box", padding: "15mm" }}>
          ...
          <div key={ei} className="hoverable-row" style={{
            ...
            {exp.roles.map((role, ri) => (
              <div key={ri} className="hoverable-row" style={{ marginTop: "6px", marginLeft: "8px", borderLeft: `2px solid ${primary}`, paddingLeft: "10px" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 6 }}>
                  <E value={role.title} onChange={(v) => updateRoleField(ei, ri, "title", v)} style={{ fontStyle: "italic", fontWeight: "600", color: secondary, fontSize: "11px" }} />
                ...
                <ul style={{ paddingLeft: "15px", margin: "5px 0 0 0" }}>
                  {role.bullets.map((b, bi) => (
                    <li key={bi} className="hoverable-row" style={{ marginBottom: "4px", color: secondary, display: "flex", alignItems: "flex-start", gap: 6, listStyle: "none" }}>
                      <span>•</span>
        ...
        {projects.map((proj, i) => (
          <div key={i} className="hoverable-row" style={{ marginBottom: "12px", borderBottom: i !== projects.length - 1 ? `1px dashed ${borderCol}` : "none", paddingBottom: "8px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 6 }}>
              <E value={proj.title} onChange={(v) => updateProjectField(i, "title", v)} style={{ fontWeight: "bold", display: "block", color: primary, flex: 1 }} />
            ...
            <E value={proj.description} onChange={(v) => updateProjectField(i, "description", v)} style={{ color: secondary }} />
          </div>
        ))}
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "40px", marginTop: "10px" }}>
          ...
          <div>
            ...
            {skills.map((row, ri) => (
              <div key={ri} className="hoverable-row" style={{ marginBottom: "10px" }}>
          ...
          <div>
            ...
            {education.map((edu, i) => (
              <div key={i} className="hoverable-row" style={{ marginBottom: "10px", borderBottom: i !== education.length - 1 ? `1px dashed ${borderCol}` : "none", paddingBottom: "8px" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "2px" }}>
                  <E value={edu.school} onChange={(v) => updateEduField(i, "school", v)} style={{ color: secondary, fontSize: "10.5px", flex: 1 }} />
            ...
            <div style={{ marginTop: "15px" }}>
              <div style={{ fontSize: "10px", fontWeight: "bold", textTransform: "uppercase", color: secondary, marginBottom: "5px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              {certifications.map((cert, i) => (
                <div key={i} className="hoverable-row" style={{ fontSize: "10.5px", color: secondary, marginBottom: "4px", display: "flex", alignItems: "center", gap: 6 }}>
                  <span>•</span>
