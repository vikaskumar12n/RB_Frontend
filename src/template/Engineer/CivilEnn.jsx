...
const SectionTitle = ({ children, onAdd, showAdd = false }) => (
  <div style={{ fontSize: "12px", fontWeight: "bold", color: primary, textTransform: "uppercase", marginBottom: "12px", borderBottom: `1px solid ${line}`, paddingBottom: "2px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
    <span>{children}</span>
    {showAdd && onAdd && (
...
const CivilEngineerTemplate = ({ data: propData, setData: setPropData }) => {
  ...
  // ========== PROJECTS FUNCTIONS ==========
  const addProject = () => u("projects", [...ref.current.projects, { name: "New Project", detail: "Project detail" }]);
        ...
        <div style={{ padding: "8mm 15mm" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1.3fr 0.7fr", gap: "35px" }}>
                ...
                <div key={ei} className="hoverable-row" style={{
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 6 }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
                      <E value={exp.period} onChange={(v) => updateExpField(ei, "period", v)} style={{ fontSize: "11px" }} />
                  ...
                  {exp.roles.map((role, ri) => (
                    <div key={ri} className="hoverable-row" style={{ marginTop: "6px", marginLeft: "10px", borderLeft: `1px solid ${line}`, paddingLeft: "10px" }}>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 6 }}>
                        <E value={role.title} onChange={(v) => updateRoleField(ei, ri, "title", v)} style={{ fontWeight: "600", fontSize: "11px", color: secondary, display: "block", marginTop: "2px" }} />
                      ...
                      <ul style={{ margin: "6px 0", paddingLeft: "18px" }}>
                        {role.bullets.map((b, bi) => (
                          <li key={bi} className="hoverable-row" style={{ fontSize: "10.5px", marginBottom: "4px", display: "flex", alignItems: "flex-start", gap: 6, listStyle: "none" }}>
                            <span>•</span>
            ...
            <div>
              ...
              {projects.map((p, i) => (
                <div key={i} className="hoverable-row" style={{ marginBottom: "12px", borderBottom: i !== projects.length - 1 ? `1px dashed ${line}` : "none", paddingBottom: "8px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 6 }}>
                    <E value={p.name} onChange={(v) => updateProjectField(i, "name", v)} style={{ fontWeight: "bold", fontSize: "11px", flex: 1 }} />
                  ...
                  <E value={p.detail} onChange={(v) => updateProjectField(i, "detail", v)} style={{ fontSize: "10.5px", color: secondary, marginTop: "2px" }} />
                </div>
              ))}
              ...
              {education.map((edu, i) => (
                <div key={i} className="hoverable-row" style={{ marginBottom: "12px", borderBottom: i !== education.length - 1 ? `1px dashed ${line}` : "none", paddingBottom: "8px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 6 }}>
                  ...
                  <E value={edu.school} onChange={(v) => updateEduField(i, "school", v)} style={{ fontSize: "10.5px", color: secondary }} />
