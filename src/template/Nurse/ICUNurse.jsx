...
const SectionTitle = ({ children, onAdd, showAdd = false }) => (
  <div style={{ fontSize: "13px", fontWeight: "bold", paddingBottom: "5px", textTransform: "uppercase", marginBottom: "12px", borderBottom: `1.5px solid ${black}`, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
    <span>{children}</span>
    {showAdd && onAdd && (
              ...
              {experience.map((exp, ei) => (
                <div key={ei} className="hoverable-row" style={{
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 6 }}>
                    <E value={exp.company} onChange={(v) => updateExpField(ei, "company", v)} style={{ fontWeight: "bold", fontSize: "13px", textTransform: "uppercase" }} />
                  ...
                  {exp.roles.map((role, ri) => (
                    <div key={ri} className="hoverable-row" style={{ marginTop: "8px", marginLeft: "10px", borderLeft: `2px solid ${black}`, paddingLeft: "10px" }}>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 6 }}>
                        <E value={role.title} onChange={(v) => updateRoleField(ei, ri, "title", v)} style={{ fontWeight: "bold", fontSize: "12px", display: "block", marginTop: "4px", fontStyle: "italic" }} />
                      ...
                      <ul style={{ margin: "10px 0", paddingLeft: "20px", listStyleType: "disc" }}>
                        {role.bullets.map((b, bi) => (
                          <li key={bi} className="hoverable-row" style={{ fontSize: "11.5px", marginBottom: "6px", lineHeight: "1.5", display: "flex", alignItems: "flex-start", gap: 6, listStyle: "none" }}>
                            <span>•</span>
            ...
            <div>
              ...
              <div style={{ marginBottom: "30px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                  {skills.map((s, i) => (
                    <div key={i} className="hoverable-row" style={{ fontSize: "11px", paddingBottom: "10px", fontWeight: "bold", borderLeft: `3px solid ${black}`, paddingLeft: "10px", display: "flex", alignItems: "center", gap: 6 }}>
              ...
              <div style={{ marginBottom: "30px", border: `1px solid ${black}`, padding: "15px" }}>
                <div style={{ fontSize: "13px", fontWeight: "bold", textTransform: "uppercase", marginBottom: "12px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <E value={certTitle} onChange={(v) => u("certTitle", v)} />
                  <IconBtn onClick={addCert} color="#6366f1"><Plus size={8} /> Add</IconBtn>
                </div>
                {certs.map((c, i) => (
                  <div key={i} className="hoverable-row" style={{ fontSize: "10.5px", marginBottom: "6px", fontWeight: "bold", display: "flex", alignItems: "center", gap: 6 }}>
              ...
              <div>
                ...
                {education.map((edu, i) => (
                  <div key={i} className="hoverable-row" style={{ marginBottom: "15px", borderBottom: i !== education.length - 1 ? `1px dashed ${darkGray}` : "none", paddingBottom: "10px" }}>
